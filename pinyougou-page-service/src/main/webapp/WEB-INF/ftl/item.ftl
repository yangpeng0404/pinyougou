            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
				            <#if  (imageList?size>0)>
                                <img jqimg="${imageList[0].url}"src="${imageList[0].url}"width="200px" height="200px" />
                            </#if>
                        </span>
                    </div>
                    <!--下方的缩略图-->
		                    ...
		                    <dl>
                                <dt>
			                        ...
			                        <#list specification.attributeValue as value>
				                        <dd><a href="javascript:;" :class="{selected:isSelected('${specification.attributeName}','${value}')}" @click="selectSpecifcation('${specification.attributeName}','${value}')">
                                            ${value}
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="#" @click="addGoodsToCartList()" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
